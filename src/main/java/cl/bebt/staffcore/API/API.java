...
public class API {
    ...
    public static boolean getFrozenStatus(String player) {
        ...
        try {
            return Bukkit.getPlayer(player).getPersistentDataContainer().has(new NamespacedKey((Plugin)plugin, "frozen"), PersistentDataType.STRING);
        } catch (NullPointerException error) {
            return false;
        }
    }
    ...
    public static boolean getVanishedStatus(String player) {
        ...
        try {
            return Bukkit.getPlayer(player).getPersistentDataContainer().has(new NamespacedKey((Plugin)plugin, "vanished"), PersistentDataType.STRING);
        } catch (NullPointerException error) {
            return false;
        }
    }
    ...
    public static boolean getStaffStatus(String player) {
        ...
        try {
            return Bukkit.getPlayer(player).getPersistentDataContainer().has(new NamespacedKey((Plugin)plugin, "staff"), PersistentDataType.STRING);
        } catch (NullPointerException error) {
            return false;
        }
    }
    ...
    public static boolean getStaffChatStatus(String player) {
        ...
        try {
            return Bukkit.getPlayer(player).getPersistentDataContainer().has(new NamespacedKey((Plugin)plugin, "staffchat"), PersistentDataType.STRING);
        } catch (NullPointerException error) {
            return false;
        }
    }
    ...
    public static boolean getFlyingStatus(String player) {
        ...
        try {
            return Bukkit.getPlayer(player).getPersistentDataContainer().has(new NamespacedKey((Plugin)plugin, "flying"), PersistentDataType.STRING);
        } catch (NullPointerException error) {
            return false;
        }
    }
    ...
    public static void setStaffChatStatus(Player target, boolean status) {
        if (mysqlEnabled()) {
            ...
            target.getPersistentDataContainer().set(new NamespacedKey((Plugin)plugin, "staffchat"), PersistentDataType.STRING, "staffchat");
        } else {
            target.getPersistentDataContainer().remove(new NamespacedKey((Plugin)plugin, "staffchat"));
        }
    }
