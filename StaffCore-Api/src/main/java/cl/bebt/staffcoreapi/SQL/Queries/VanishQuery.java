...
public class VanishQuery {
    ...
    public static void enable( String player ){
        if ( AltsQuery.PlayerExists( player ) ) {
            try {
                PreparedStatement statement = SqlUtils.getConnection( ).prepareStatement( "UPDATE sc_vanish SET Enabled=? WHERE Name=?" );
    ...
    public static List < String > getVanishedPlayers( ){
        ...
        try {
            PreparedStatement statement = SqlUtils.getConnection( ).prepareStatement( "SELECT * FROM sc_vanish where Enabled = 'True'" );
    ...
    public static String isVanished( String player ){
        try {
            PreparedStatement statement = SqlUtils.getConnection( ).prepareStatement( "SELECT Enabled FROM sc_vanish WHERE Name=?" );
