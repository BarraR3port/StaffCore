...
public class WarnQuantity extends PaginatedMenu {
    ...
    public void handleMenu( InventoryClickEvent e ){
        ...
        if ( e.getCurrentItem( ).getItemMeta( ).getPersistentDataContainer( ).has( new NamespacedKey( plugin , "seconds" ) , PersistentDataType.STRING ) ) {
            p.closeInventory( );
            WarnManager.createWarn( p , warned , reason , time , "s" );
            ...
            p.closeInventory( );
            WarnManager.createWarn( p , warned , reason , time , "m" );
            ...
            p.closeInventory( );
            WarnManager.createWarn( p , warned , reason , time , "h" );
            ...
            p.closeInventory( );
            WarnManager.createWarn( p , warned , reason , time , "d" );
