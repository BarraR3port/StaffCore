...
import cl.bebt.staffcore.utils.Serializer;
...
public class PersistentData {
    ...
    public PersistentData( HashMap < String, Object > hashMap , String itemStack , UUID itemUUID , UUID ownerUUID , PersistentDataType type ){
    ...
    public void setItemStack( ItemStack itemStack ){
        ItemStack = itemStack.serialize( ).toString( );
    }
